#!/usr/bin/python3
"""
    This module contains test cases for user.py
"""
import unittest
...
class TestUser(unittest.TestCase):
    ...
    def test_to_dict_method(self):
        ...
        self.assertEqual(User.__name__, from_to_dict['__class__'])
    ...
    def test_creatUser_from_dictionary_as_kwargs(self):
    ...
    def test_createUser_from_dictionary_as_kwargs_empty(self):
        """ Test for create a obj from a empty dictionary """
        empty_dict = dict()
        obj1 = User(**empty_dict)
        self.assertIs(type(obj1), User)
        self.assertIs(type(obj1.id), str)
        self.assertIs(type(obj1.created_at), datetime)
        self.assertIs(type(obj1.updated_at), datetime)

    def test_createUser_from_dictionary_as_kwargs_diff_fileds(self):
    ...
    def test_createUser_from_dictionary_as_kwargs_wrong_format(self):
    ...
    def test_createUser_from_args(self):
