#!/usr/bin/python3
"""
    This module contains test cases for state.py
"""
import unittest
...
class TestState(unittest.TestCase):
    """" Unitest cases for State class """
    def setUp(self) -> None:
        super().setUp()
        self.obj = State()
        self.obj2 = State()

    def test_StateInstance(self):
    ...
    def test_to_dict_method(self):
        ...
        self.assertEqual(State.__name__, from_to_dict['__class__'])
    ...
    def test_creatState_from_dictionary_as_kwargs(self):
    ...
    def test_createState_from_dictionary_as_kwargs_empty(self):
        """ Test for create a obj from a empty dictionary """
        empty_dict = dict()
        obj1 = State(**empty_dict)
        self.assertIs(type(obj1), State)
        self.assertIs(type(obj1.id), str)
        self.assertIs(type(obj1.created_at), datetime)
        self.assertIs(type(obj1.updated_at), datetime)

    def test_createState_from_dictionary_as_kwargs_diff_fileds(self):
    ...
    def test_createState_from_dictionary_as_kwargs_wrong_format(self):
    ...
    def test_createState_from_args(self):
